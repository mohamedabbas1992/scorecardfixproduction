...
{   
  ...
  " where id <=(select id from md_term where term_name='"+req.query.termname+"'))order by subject_id"; 
...
{   
  ...
  " where id <=(select id from md_term where term_name='"+req.query.termname+"')) ";
  console.log('.........................Score card....................................');
  //console.log(qur);
  connection.query(qur,
    function(err, rows)
...
{   
  ...
  " where id <=(select id from md_term where term_name='"+req.query.termname+"')) order by term_id";
...
"g.term_id=(select term_name from md_term where term='"+req.query.term+"') and s.grade_id in(select grade_id from mp_teacher_grade where "+ 
...
{  
    ...
    " where id <=(select id from md_term where term_name='"+req.query.termname+"')) group by term_name,subject_id,student_id";
...
var qur="select * from mp_grade_subject s join md_grade_assesment_mapping g on(s.grade_id=g.grade_id) join md_subject sub on(sub.subject_id=s.subject_id) join md_class_section c on(g.grade_name=c.class) where s.school_id='"+req.query.schoolid+"' and "+
"g.school_id='"+req.query.schoolid+"' and c.school_id='"+req.query.schoolid+"' and c.academic_year='"+req.query.academicyear+"' and s.academic_year='"+req.query.academicyear+"' and g.academic_year='"+req.query.academicyear+"' and "+
"g.term_id=(select term_name from md_term where term='"+req.query.termname+"') and s.grade_id in(select grade_id from mp_teacher_grade where "+ 
"id='"+req.query.loggedid+"' and role_id='"+req.query.roleid+"') and s.subject_id not in('s14') order by g.grade_name,c.section,g.assesment_name,sub.subject_name";
...
var qur="SELECT * FROM  tr_student_to_subject WHERE school_id='"+req.query.schoolnames+"' and student_id='"+req.query.studentid+"' and academic_year='"+req.query.Acadamicyear+"' and grade='"+req.query.gradeid+"' and  class_id='"+req.query.sectionid+"' and lang_pref='"+req.query.langugagepref+"' and grade='"+req.query.grade+"' and flag='active'";
 

 
  var qur1=  "update tr_student_to_subject set subject_id='"+req.query.subjectid+"' where school_id='"+req.query.schoolnames+"' and academic_year='"+req.query.Acadamicyear+"' and grade='"+req.query.gradeid+"' and student_id='"+req.query.studentid+"' and class_id='"+req.query.sectionid+"' and lang_pref='"+req.query.langugagepref+"' and grade='"+req.query.grade+"' and flag='active'";
...
{  
    ...
    console.log(qur1);
    console.log(qur2);
    console.log('------------enrichment grade master end-------------');
    var grade=[];
    var detail=[];
    connection.query(qur,function(err, rows)
    {
...
{  
  ...
  " where id <=(select id from md_term where term_name='"+req.query.termname+"')) group by term_name,assesment_id,subject_id,student_id,grade order by term_name,subject_id";
...
var qur="SELECT * FROM tr_term_assesment_marks WHERE school_id='"+req.query.schoolid+"' and "+
" academic_year='"+req.query.academicyear+"' and assesment_id='"+req.query.assesmenttype+"' and term_name='"+req.query.termname+"' and "+
" grade='"+req.query.grade+"' and section='"+req.query.section+"' and subject_id='"+req.query.subject+"' order by student_name,category,sub_cat_sequence";
var categorycnt="SELECT subject_id,subject_name,category_id,category_name,count(sub_category_id) as cnt FROM subject_mapping WHERE school_id='"+req.query.schoolid+"' and academic_year='"+req.query.academicyear+"' and "+
...
" grade_name='"+req.query.grade+"' and subject_name='"+req.query.subject+"' and assesment_type='"+req.query.assesmenttype+"' order by category_id,sub_seq";
...
app.post('/fnparentinfomation-service',  urlencodedParser,function (req,res)
  {  
  var qur="UPDATE parent SET parent_name='"+req.query.fathername1+"',mother_name='"+req.query.mothername1+"',mother_mobile='"+req.query.mothermob+"',mobile='"+req.query.fathermob+"',alternate_mail='"+req.query.motheremail+"',email='"+req.query.fatheremail+"',address1='"+req.query.address1+"',address2='"+req.query.address2+"',address3='"+req.query.address3+"',city='"+req.query.city+"',pincode='"+req.query.pincode+"'  WHERE school_id='"+req.query.schoolid+"' and student_id='"+req.query.studid+"' and academic_year='"+req.query.academic_year+"'";
    console.log('------------update return status -------------');
    console.log(qur);
    connection.query(qur,
    function(err, rows)
...
{ 
    ...
    "(select assesment_name from md_assesment where assesment_id>='"+req.query.currlevel+"') and school_id='"+req.query.schoolid+"' "+
    ...
    "assesment_id='"+req.query.updatelevel+"') where school_id='"+req.query.schoolid+"' "+
    "and academic_year='"+req.query.academicyear+"' and term_name='"+req.query.termname+"' and grade='"+req.query.grade+"' and section='"+req.query.section+"' "+
    ...
    "assesment_id>='"+req.query.currlevel+"')";
...
{ 
    ...
    var qur9="select * from md_admission where class_for_admission='"+req.query.grade+"'  and school_id='"+req.query.schoolid+"' and academic_year='ay-"+req.query.academicyear+"'";
    ...
    var indicator=[];
        ...
        {
          indicator=rows;
          connection.query(qur9,  function(err, rows)
        {
        if(!err)
        {
        res.status(200).json({'status':rows,'assesment':typearr,'subject':subarr,'category':catarr,'subcategory':subcatarr,'enrich':enricharr,'student':student,'ascii':ascii,'indicator':indicator});
        }
          });
        }
        });
...
app.post('/performance-fetchexceptionexcelassesmentinfo-service',  urlencodedParser,function (req, res)
{ 
    if(req.query.assesment=='EBOY'||req.query.assesment=='EMOY'||req.query.assesment=='EEOY') 
    {
    var qur1="SELECT assesment_type,count(distinct(subject_id)) as subcount,count(distinct(category_id)) as catcount, "+
    " count(distinct(sub_category_id)) as subcatcount FROM enrichment_subject_mapping WHERE school_id='"+req.query.schoolid+"' and "+
    " academic_year='"+req.query.academicyear+"' and grade_name='"+req.query.grade+"' and assesment_type in(select distinct(assesment_id) "+
    ...
    " academic_year='"+req.query.academicyear+"' and grade_name='"+req.query.grade+"' and assesment_type in(select distinct(assesment_id) "+
    " from tr_beginner_assesment_marks where school_id='"+req.query.schoolid+"' and academic_year='"+req.query.academicyear+"' and "+
    " grade_id='"+req.query.grade+"') and subject_name in('"+req.query.subject+"') and assesment_type in('BOY','MOY','EOY') group by assesment_type order by (SELECT id FROM enrichment_assesment_type where name=assesment_type)";

    var qur2="SELECT assesment_type,subject_id,subject_name,count(distinct(subject_id)) as subcount,count(distinct(category_id)) as catcount, "+
    " count(distinct(sub_category_id)) as subcatcount FROM enrichment_subject_mapping WHERE school_id='"+req.query.schoolid+"' and "+
    " academic_year='"+req.query.academicyear+"' and grade_name='"+req.query.grade+"' and assesment_type in(select distinct(assesment_id) "+
    " from tr_beginner_assesment_marks where school_id='"+req.query.schoolid+"' and academic_year='"+req.query.academicyear+"' and "+
    " grade_id='"+req.query.grade+"') and subject_name in('"+req.query.subject+"') and assesment_type in('BOY','MOY','EOY') group by assesment_type,subject_id,subject_name order by (SELECT id FROM enrichment_assesment_type where name=assesment_type),subject_id";

    var qur3="SELECT assesment_type,subject_id,subject_name,category_id,category_name,count(distinct(subject_id)) as subcount,count(distinct(category_id)) as catcount, "+
    " count(distinct(sub_category_id)) as subcatcount FROM enrichment_subject_mapping WHERE school_id='"+req.query.schoolid+"' and "+
    " academic_year='"+req.query.academicyear+"' and grade_name='"+req.query.grade+"' and assesment_type in(select distinct(assesment_id) "+
    " from tr_beginner_assesment_marks where school_id='"+req.query.schoolid+"' and academic_year='"+req.query.academicyear+"' and "+
    " grade_id='"+req.query.grade+"') and subject_name in('"+req.query.subject+"') and assesment_type in('BOY','MOY','EOY') group by assesment_type,subject_id,subject_name,category_id,category_name order by (SELECT id FROM enrichment_assesment_type where name=assesment_type),subject_id,category_id";

    var qur4="SELECT assesment_type,subject_id,subject_name,category_id,category_name,sub_category_id,sub_category_name FROM "+
    " enrichment_subject_mapping WHERE school_id='"+req.query.schoolid+"' and academic_year='"+req.query.academicyear+"' and grade_name='"+req.query.grade+"' "+
    " and assesment_type in(select distinct(assesment_id) from tr_beginner_assesment_marks where school_id='"+req.query.schoolid+"' "+
    " and academic_year='"+req.query.academicyear+"' and grade_id='"+req.query.grade+"') and subject_name in('"+req.query.subject+"') and assesment_type in('BOY','MOY','EOY') group by assesment_type,subject_id,subject_name,category_id,category_name,sub_category_id,sub_category_name order by (SELECT id FROM enrichment_assesment_type where name=assesment_type),subject_id,category_id,sub_category_id";

    var qur5="select * from tr_beginner_assesment_marks where school_id='"+req.query.schoolid+"' and academic_year='"+req.query.academicyear+"' "+
    " and subject_name in ('"+req.query.subject+"') and grade_id='"+req.query.grade+"' and section_id='"+req.query.sectionname+"' and student_id in(select id from md_student where class_id "+
    " in(select id from md_class_section where class='"+req.query.grade+"' and section='"+req.query.sectionname+"' and flag='active')) and assesment_type in('BOY','MOY','EOY') order by (SELECT id FROM enrichment_assesment_type where name=assesment_type)";    

    var qur7="select school_id,academic_year,assesment_id,student_id,subject_name,category_name,grade,level, "+
    " ASCII(grade) as ascii from tr_beginner_assesment_marks where school_id='"+req.query.schoolid+"' and "+
    " academic_year='"+req.query.academicyear+"' and grade_id='"+req.query.grade+"' and "+
    " subject_name in ('"+req.query.subject+"') and section_id='"+req.query.sectionname+"' and assesment_id in('BOY','MOY','EOY') "+
    " group by school_id,academic_year,assesment_id,student_id,subject_name,grade,level,category_name "+
    " order by (select id from enrichment_assesment_type where assesment_id=name)";
...
{
    var qur="SELECT distinct(subject_name),assesment_type FROM enrichment_subject_mapping WHERE school_id='"+req.query.schoolid+"' "+
    " AND academic_year='"+req.query.academicyear+"' AND grade_id='"+req.query.gradeid+"' group by subject_name";
    console.log(qur);
    connection.query(qur,function(err, rows){
    if(!err)
    {  
...
app.post('/fetchreporttype-service',  urlencodedParser,function (req, res)
{
  var qur="SELECT * FROM report_type order by type_id";
  console.log('----------------------fetch reporttype------------------------');
  console.log(qur);
  var arr=[];
  connection.query(qur,function(err, rows)
    { 
...
app.post('/fetchstudentname-service',  urlencodedParser,function (req,res)
{   
  var schoolid={school_id:req.query.schoolid};
  var gradeid={grade_id:req.query.grade};
  var sectionid={section_id:req.query.section};
  var qur="SELECT * FROM md_student where class_id=(select class_id from mp_grade_section where grade_id='"+req.query.grade+"' and section_id='"+req.query.section+"'  and school_id='"+req.query.schoolid+"' and academic_year='"+req.query.academicyear+"') and school_id='"+req.query.schoolid+"' and academic_year='"+req.query.academicyear+"' and flag='active'";
  console.log(qur);
  var  verifyarr=[];
    connection.query(qur, function(err, rows){
    if(!err)
...
app.post('/fetchdashboardinfo-service',  urlencodedParser,function (req,res)
{   
  var qur="SELECT * FROM md_student where id='"+req.query.studentid+"' and school_id='"+req.query.schoolid+"' order by academic_year";
  var qur1="SELECT * FROM md_grade_assesment_report_dashboard where school_id='"+req.query.schoolid+"' and grade_name='"+req.query.gradename+"'";
  var qur2="SELECT * FROM md_grade_assesment_report_master where school_id='"+req.query.schoolid+"' and student_id='"+req.query.studentid+"' and assesment_id not in('BOY','MOY','EOY') and subject_name='English' order by academic_year,term_id,assesment_id";
  var q1="select subject_id,count(distinct(term_id)) as count from md_grade_assesment_report_dashboard where "+
  " school_id='"+req.query.schoolid+"' and grade_name='"+req.query.gradename+"' and subject_id='s1' group by subject_id order by subject_id";
  var q2="select term_id,subject_id,count(distinct(assesment_id)) as count from md_grade_assesment_report_dashboard where "+
  " school_id='"+req.query.schoolid+"' and grade_name='"+req.query.gradename+"' and subject_id='s1' group by subject_id,term_id order by term_id,subject_id,CAST(seq AS UNSIGNED)";
  var q3="select term_id,subject_id,assesment_id from md_grade_assesment_report_dashboard where "+
  " school_id='"+req.query.schoolid+"' and grade_name='"+req.query.gradename+"' and subject_id='s1' group by subject_id,term_id,assesment_id "+
  " order by term_id,CAST(seq AS UNSIGNED)";
  var q4="select academic_year,term_id,subject_id,assesment_id from md_grade_assesment_report_dashboard where "+
  " school_id='"+req.query.schoolid+"' and grade_name='"+req.query.gradename+"' and subject_id='s1' "+
  " and academic_year in(SELECT academic_year FROM md_student where id='"+req.query.studentid+"' and school_id='"+req.query.schoolid+"' )group by academic_year,subject_id,term_id,assesment_id "+
  " order by term_id";
  console.log("-------------------------------------");
  console.log(qur);
  console.log(qur1);
  ...
  var a3=[];
    ...
    if(!err)
    {
      res.status(200).json({'acasses':rows,'student': stud,'mark': mark,'assesment': assesment,'term':a1,'termspan':a2,'termasses':a3});
    }
    });
    }
    });
...
app.post('/fetchdashboardinfo-service1',  urlencodedParser,function (req,res)
{   
  var qur="SELECT * FROM md_student where id='"+req.query.studentid+"' and school_id='"+req.query.schoolid+"' order by academic_year";
  var qur1="SELECT * FROM md_grade_assesment_report_dashboard where school_id='"+req.query.schoolid+"' and grade_name='"+req.query.gradename+"'";
  var qur2="SELECT * FROM md_grade_assesment_report_master where school_id='"+req.query.schoolid+"' and student_id='"+req.query.studentid+"' and assesment_id not in('EBOY','EMOY','EEOY') and subject_name='Mathematics' order by academic_year,term_id,assesment_id";
  var q1="select subject_id,count(distinct(term_id)) as count from md_grade_assesment_report_dashboard where "+
  " school_id='"+req.query.schoolid+"' and grade_name='"+req.query.gradename+"' and subject_id='s2' group by subject_id order by subject_id";
  var q2="select term_id,subject_id,count(distinct(assesment_id)) as count from md_grade_assesment_report_dashboard where "+
  " school_id='"+req.query.schoolid+"' and grade_name='"+req.query.gradename+"' and subject_id='s2' group by subject_id,term_id order by term_id,subject_id,CAST(seq AS UNSIGNED)";
  var q3="select term_id,subject_id,assesment_id from md_grade_assesment_report_dashboard where "+
  " school_id='"+req.query.schoolid+"' and grade_name='"+req.query.gradename+"' and subject_id='s2' group by subject_id,term_id,assesment_id "+
  " order by term_id,CAST(seq AS UNSIGNED)";
  var q4="select academic_year,term_id,subject_id,assesment_id from md_grade_assesment_report_dashboard where "+
  " school_id='"+req.query.schoolid+"' and grade_name='"+req.query.gradename+"' and subject_id='s2' "+
  " and academic_year in(SELECT academic_year FROM md_student where id='"+req.query.studentid+"' and school_id='"+req.query.schoolid+"' )group by academic_year,subject_id,term_id,assesment_id "+
  " order by term_id";
  console.log("-------------------------------------");
  console.log(qur);
...
app.post('/fetchdashboardinfo-service2',  urlencodedParser,function (req,res)
{   
  var qur="SELECT * FROM md_student where id='"+req.query.studentid+"' and school_id='"+req.query.schoolid+"' order by academic_year";
  var qur1="SELECT * FROM md_grade_assesment_report_dashboard where school_id='"+req.query.schoolid+"' and grade_name='"+req.query.gradename+"'";
  var qur2="SELECT * FROM md_grade_assesment_report_master where school_id='"+req.query.schoolid+"' and student_id='"+req.query.studentid+"' and assesment_id not in('EBOY','EMOY','EEOY') and subject_name='EVS' order by academic_year,term_id,assesment_id";
  var q1="select subject_id,count(distinct(term_id)) as count from md_grade_assesment_report_dashboard where "+
  " school_id='"+req.query.schoolid+"' and grade_name='"+req.query.gradename+"' and subject_id='s4' group by subject_id order by subject_id";
  var q2="select term_id,subject_id,count(distinct(assesment_id)) as count from md_grade_assesment_report_dashboard where "+
  " school_id='"+req.query.schoolid+"' and grade_name='"+req.query.gradename+"' and subject_id='s4' group by subject_id,term_id order by term_id,subject_id,CAST(seq AS UNSIGNED)";
  var q3="select term_id,subject_id,assesment_id from md_grade_assesment_report_dashboard where "+
  " school_id='"+req.query.schoolid+"' and grade_name='"+req.query.gradename+"' and subject_id='s4' group by subject_id,term_id,assesment_id "+
  " order by term_id,CAST(seq AS UNSIGNED)";
  var q4="select academic_year,term_id,subject_id,assesment_id from md_grade_assesment_report_dashboard where "+
  " school_id='"+req.query.schoolid+"' and grade_name='"+req.query.gradename+"' and subject_id='s4' "+
  " and academic_year in(SELECT academic_year FROM md_student where id='"+req.query.studentid+"' and school_id='"+req.query.schoolid+"' )group by academic_year,subject_id,term_id,assesment_id "+
  " order by term_id";
  console.log("-------------------------------------");
  console.log(qur);
...
app.post('/consolidatedprimarystudent-service',  urlencodedParser,function (req,res)
{ 
  // select count(distinct(academic_year))*count(distinct(term_id))*count(distinct(seq)) as count from md_grade_assesment_report_dashboard where  school_id='SCH001' and grade_name='Grade-4'  
  var q1="select academic_year,UPPER(term_id) as term_id,subject_name,UPPER(assesment_id) as assesment_id from md_grade_assesment_report_dashboard where "+
  " school_id='"+req.query.schoolid+"' and grade_name='"+req.query.gradename+"' group by academic_year,subject_id,term_id,assesment_id "+
  " order by academic_year,term_id,subject_id,CAST(seq AS UNSIGNED)";
  var q2="select distinct(academic_year) from md_grade_assesment_report_dashboard where "+
  " school_id='"+req.query.schoolid+"' and grade_name='"+req.query.gradename+"' group by academic_year order by academic_year";
  var q3="select academic_year,term_id from md_grade_assesment_report_dashboard where "+
  " school_id='"+req.query.schoolid+"' and grade_name='"+req.query.gradename+"' group by academic_year,term_id order by academic_year,term_id ";
  var q4="select academic_year,term_id,subject_name from md_grade_assesment_report_dashboard  where "+
  " school_id='"+req.query.schoolid+"' and grade_name='"+req.query.gradename+"' group by academic_year,term_id,subject_id order by academic_year,term_id,subject_id ";
  var q5="select academic_year,term_id,subject_name,assesment_name,seq from md_grade_assesment_report_dashboard where "+
  " school_id='"+req.query.schoolid+"' and grade_name='"+req.query.gradename+"' group by academic_year,term_id,subject_id,assesment_id order by academic_year,term_id,subject_id,CAST(seq AS UNSIGNED)";
  if(req.query.flag=="true"){
  var q6="SELECT * from md_grade_assesment_report_master WHERE school_id='"+req.query.schoolid+"' and student_id in(SELECT id FROM md_student where grade_id='"+req.query.gradeid+"' and school_id='"+req.query.schoolid+"' and academic_year='"+req.query.academicyear+"' "+
  " and flag='active' order by student_name) order by academic_year,term_id,subject_id,assesment_id,student_id";
  var q7="SELECT * FROM md_student where grade_id='"+req.query.gradeid+"' and school_id='"+req.query.schoolid+"' and academic_year='"+req.query.academicyear+"' and flag='active' order by student_name";
  }
  else{
  var q6="SELECT * from md_grade_assesment_report_master WHERE school_id='"+req.query.schoolid+"' and student_id in(SELECT id FROM md_student where class_id=(select class_id from mp_grade_section "+
  " where grade_id='"+req.query.gradeid+"' and section_id='"+req.query.sectionid+"'  and school_id='"+req.query.schoolid+"' and academic_year='"+req.query.academicyear+"') "+
  " and school_id='"+req.query.schoolid+"' and academic_year='"+req.query.academicyear+"' and flag='active' order by student_name) order by academic_year,term_id,subject_id,assesment_id,student_id";
  var q7="SELECT * FROM md_student where class_id=(select class_id from mp_grade_section where grade_id='"+req.query.gradeid+"' and section_id='"+req.query.sectionid+"'  and school_id='"+req.query.schoolid+"' and academic_year='"+req.query.academicyear+"') and school_id='"+req.query.schoolid+"' and academic_year='"+req.query.academicyear+"' and flag='active' order by student_name";
  }
  var q8="SELECT * FROM md_admission WHERE school_id='"+req.query.schoolid+"' and academic_year='AY-"+req.query.academicyear+"' and class_for_admission='"+req.query.gradename+"'";
  console.log("-------------------------------------");
  console.log(q1);
  console.log(q2);
  console.log(q3);
  ...
  connection.query(q1, function(err, rows){
    ...
    {
      a7=rows; 
    connection.query(q8, function(err, rows){
    if(!err)
    {
      a8=rows;  
      res.status(200).json({'status':a8,'student':a7,'mark':a6,'totalassesment':a1,'acyear':a2,'term':a3,'subject':a4,'assesment':a5});
    }
    });
    }
    });
    ...
    // if(!err)
    // {
    //   res.status(200).json({'acasses':rows,'mark': mark,'assesment': assesment,'term':a1,'termspan':a2,'termasses':a3,'acyear':a4});
    // }
    // });
    // }
    // });
